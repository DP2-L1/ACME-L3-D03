...
<acme:list>
	...
	<acme:list-column code="administrator.banner.list.label.displayPeriodStart" path="displayPeriodStart" width="30%"/>
	<acme:list-column code="administrator.banner.list.label.displayPeriodEnd" path="displayPeriodEnd" width="30%"/>
