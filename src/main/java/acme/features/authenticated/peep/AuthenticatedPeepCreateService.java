...
@Service
public class AuthenticatedPeepCreateService extends AbstractService<Authenticated, Peep> {
	...
	public void load() {
		...
		account = this.repository.findUserAcountById(super.getRequest().getPrincipal().getAccountId());

		object = new Peep();
		object.setInstationMoment(moment);
		object.setTitle("");
		object.setNick(account.getIdentity().getFullName());
		object.setMessage("");
		object.setEmail("");
		object.setLink("");
